	...
	public class Spawner3 extends Spawner
	{
		public function Spawner3() 
		{
			...
			for (var i:int = 0; i < 10; i++)
			{
				...
				var tempBlock2:submarine = new submarine( -100, -100);
				tempBlock2.exists = false;
				blockGroup.add(tempBlock2);
				add(tempBlock2.deadEmitter);
